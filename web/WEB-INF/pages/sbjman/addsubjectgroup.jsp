            ...
            <form method="post" action="<%=basePath%>sbjman/addSubjectGroup">
                <fieldset>
                    ...
                    <div class="am-form-group">
                        <label>学科组名称：</label>
                        <input type="text" name="groName" placeholder="输入学科组名称" class="am-form-field" required/>
                        <label>学科组提交名额：</label>
                        <input type="text" name="subNum" placeholder="输入名额" class="am-form-field" required/>
                    </div>
