...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">学科管理</strong> / <small>管理学科组信息/修改学科组</small></div>
        </div>

        <div class="am-cf am-padding">
            <form method="post" action="<%=basePath%>sbjman/changeSubjectGroup">
