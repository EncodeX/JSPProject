...
<div class="admin-content">
    ...
    <div class="am-cf am-padding">
        <a class="am-btn am-btn am-btn-secondary" href="<%=basePath%>userinfo/addExpert"><i class="am-icon-plus"></i>增加评审专家账号</a>
        <a class="am-btn am-btn am-btn-secondary" href="<%=basePath%>userinfo/addGroup"><i
    ...
    <div class="am-cf am-padding">
        <div class="am-g">
            ...
            <div class="am-u-sm-7 am-u-sm-offset-4">
                ...
                <a class="am-btn am-btn am-btn-secondary" href="<%=basePath%>userinfo/groupmain">查看推荐单位账号</a>
                <a class="am-btn am-btn am-btn-secondary" href="<%=basePath%>userinfo/groupmain">查看申请者账号</a>
        ...
        <table class="am-table">
            ...
            <c:forEach items="${subjectGroups}" var="subjectGroup" varStatus="status">
                <tr>
                    ...
                    <td><a href="<%=basePath%>userinfo/changeGroup?name=${subjectGroup.groName}">修改</a>
                        <a href="<%=basePath%>userinfo/deleteGroup?name=${subjectGroup.groName}">删除</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        ...
        <ul class="am-pagination am-pagination-right">
            ...
            %>
            <li><a href="<%=basePath%>userinfo/groupmain?page=<%=pages-1%>">&laquo;</a></li>
            <%
                }
                if (pageAmount <= 5 || pages < 3) {
                    ...
                    for (int i = 1; i <= temp; i++) {
                        if (i == pages) {
            %>
            <li class="am-active"><a href="<%=basePath%>userinfo/groupmain?page=<%=i%>"><%=i%>
            </a></li>
            <%
            } else {
            %>
            <li><a href="<%=basePath%>userinfo/groupmain?page=<%=i%>"><%=i%>
            </a></li>
            <%
                    }
                }
            ...
            <%
                ...
                if (pages < pageAmount) {
            %>
            <li><a href="<%=basePath%>userinfo/groupmain?page=<%=pages+1%>">&raquo;</a></li>
            <%
            } else {
            %>
