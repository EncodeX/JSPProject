            ...
            <form method="post" action="<%=basePath%>userinfo/addGroupToDB">
                <fieldset>
                    ...
                    <div class="am-form-group">
                        <label for="doc-vld-name-1">推荐单位名称：</label>
                        <input type="text" name="groName" id="doc-vld-name-1" minlength="3" placeholder="输入推荐单位名称"
                               class="am-form-field" required/>
                        <label for="doc-vld-ID">推荐单位提交名额：</label>
                        <input type="text" name="subNum" id="doc-vld-ID" minlength="3" placeholder="输入推荐名额"
                               class="am-form-field" required/>
                    </div>
